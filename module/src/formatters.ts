...
export const getMessageFormat = memoizeIntlConstructor(IntlMessageFormat as any).bind(null);
export const getRelativeFormat = memoizeIntlConstructor(IntlRelativeFormat as any).bind(null);
